package com.gen.script.oauth.handler;

import static com.gen.script.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static com.gen.script.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
...
import com.gen.script.oauth.info.OAuth2UserInfoFactory;
...
import com.gen.script.utils.CookieUtil;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        AuthToken accessToken = tokenProvider.createAuthToken(
                userInfo.getId(),
                roleType.getCode(),
                new Date(now.getTime() + jwtProperties.getTokenExpiry())
        );
        log.debug("[OAuthLogin][accessToken][{}]",accessToken.getToken());
        // refresh 토큰 설정
        ...
        log.debug("\n[SuccessHandler][refreshToken][{}]",refreshToken.getToken());
